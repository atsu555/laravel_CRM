                                    ...
                                    <table class="table-auto w-full text-left whitespace-no-wrap">
                                        ...
                                        <tbody>
                                            <tr v-for="customer in customers.data" :key="customer.id">
                                                ...
                                                <td class="px-4 py-3 border-gray-200">{{ customer.name }}</td>
                                                <td class="px-4 py-3 border-gray-200">{{ customer.kana }}</td>
                                                <td class="px-4 py-3 border-gray-200">{{ customer.tel }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
